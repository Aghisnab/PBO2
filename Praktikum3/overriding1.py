...
member1 = membership('Qisti','D230329','Spa',300000)
member1.bayar()
member1.display()

member2 = gold('Aghisna','B210112','Facial Treatment',750000)
member2.bayar()
member2.display()

member3 = platinum('Winter','K220101','Facial Treatment',750000)
member3.bayar()
member3.display()
